...
import {
  LayoutDashboard, FolderOpen, Upload, BarChart2, Settings, LogOut, ChevronLeft, ChevronRight,
} from 'lucide-react';
      ...
      >
        ...
        <div className="p-3 border-t border-border space-y-3">
          ...
          <button
            ...
            className={`flex items-center gap-3 w-full px-3 py-2 rounded-lg text-sm text-muted-foreground hover:text-foreground hover:bg-glass-hover transition-all ${collapsed ? 'justify-center' : ''}`}
          >
